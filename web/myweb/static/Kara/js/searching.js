...
$(".lyric").change(function (){
fileName = $(this)[0].files[0].name;
$('.filename_lyric').html(fileName);
$('.dropzone_lyric .upload_lyric').hide();
});


$(".vocal").change(function (){
fileName = $(this)[0].files[0].name;
$('.filename_vocal').html(fileName);
$('.dropzone_vocal .upload_vocal').hide();
});