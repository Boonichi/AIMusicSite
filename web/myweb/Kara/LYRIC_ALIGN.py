...
labels=("ẻ","6","ụ","í","3","ỹ","ý","ẩ","ở","ề","õ","7","ê","ứ","ỏ","v","ỷ","a","l","ự","q","ờ","j","ố","à","ỗ","n","é","ủ","у","ô","u","y","ằ","4","w","b","ệ","ễ","s","ì","ầ","ỵ","8","d","ể","|","r","ũ","c","ạ","9","ế","ù","ỡ","2","t","i","g","́ ","ử","̀ ","á","0","ậ","e","ộ","m","ẳ","ợ","ĩ","h","â","ú","ọ","ồ","ặ","f","ữ","ắ","ỳ","x","ó","ã","ổ","ị","̣ ","z","ả","đ","è","ừ","ò","ẵ","1","ơ","k","ẫ","p","ấ","ẽ","ỉ","ớ","ẹ","ă","o","ư","5","<","*")
